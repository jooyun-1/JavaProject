package JavaProject.hotelreserv;
...
public class Hotelres extends JFrame{
   ...
   public Hotelres(TourApp app) {
      ...
      bt_back.setBounds(0,0,50,50);
      bt_back.setBackground(Color.LIGHT_GRAY);
   ...
   public void getList() {
      String sql="select * from h_reserv order by member_sid desc";
      ...
      try {
         ...
         while(rs.next()){
            ...
            reserv.setMember_id(rs.getInt("member_sid"));
